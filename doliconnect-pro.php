...
if (!empty(number_format($postadh->federal))) print "<br><small class='text-justify text-muted '>".__( 'Include federal part of ', 'doliconnect-pro')." ".doliprice($postadh->federal)."</small>";
